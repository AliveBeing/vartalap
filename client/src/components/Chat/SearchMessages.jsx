...
function SearchMessages() {
  ...
  useEffect(()=> {
   ...
   return <div className="border-conversation-border border-1 w-full bg-slate-200 flex flex-col z-10 max-h-screen">
    <div className="h-16 px-4 py-5 gap-10 items-center flex  bg-slate-300 text-primary-strong">
       <IoClose className="cursor-pointer text-black text-2xl" 
     ...
     <div className="flex justify-center h-full flex-col">
      {searchTerm.length>0 && !searchedMessages.length && (<span className="text-black w-full flex justify-center">
        No messages found
        </span>
       ) }
