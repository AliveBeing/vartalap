      ...
      <div className="min-h-full flex flex-col justify-center mt-3 pr-2 w-full">
        ...
        <div className="flex border-b border-conversation-border pb-2 pt-1 pr-2">
          <div className="flex justify-between w-full">
            <span className="text-slate-500 line-clamp-1 text-sm">
              {isContactsPage ? (
                data?.about || "\u00A0"
              ) : (
            ...
            {
              data.totalUnreadMessages>0 && <span className="bg-slate-500 px-[5px]  rounded-full text-sm text-white">{data.totalUnreadMessages}</span>
            }
          </div>
        </div>
      </div>
